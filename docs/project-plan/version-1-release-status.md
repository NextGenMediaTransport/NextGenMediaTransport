...
| **5** — Integrations | OBS, virtual camera/audio, SDKs | **In progress** (OBS input path) | **v1.0:** [`ngmt-obs-plugin`](https://github.com/NextGenMediaTransport/ngmt-obs-plugin) **input** implements **VMX v1** + Discovery on **macOS** (toward public beta); see [Phase 5](./05-Phase-5-Integrations-and-Ecosystem.md). Virtual camera/audio still scoped. **Post-v1.0 / Phase 5b:** Python and other SDK wrappers — not gating v1.0. |
